...
describe("POST /auth/login", () => {
    ...
    describe("Given All Fields", () => {
        it('should check user exist or not', () => __awaiter(void 0, void 0, void 0, function* () {
            const data = {
                email: "rsuneel47@gmail.com",
                password: "password"
            };
            const res = yield (0, supertest_1.default)(app_1.default).post("/auth/login").send(data);
